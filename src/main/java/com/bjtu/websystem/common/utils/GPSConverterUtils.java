...
public class GPSConverterUtils {
    ...
    /*
    左下角经纬度坐标（单位：度）：117.421875000,23.774414063 (-50, -50, 0)
    左上角经纬度坐标（单位：度）：117.421875000,23.906250000 (-50, 50, 0)
    右上角经纬度坐标（单位：度）：117.553710938,23.906250000 (50, 50, 0)
    右下角经纬度坐标（单位：度）：117.553710938,23.774414063 (50, -50, 0)
    */
